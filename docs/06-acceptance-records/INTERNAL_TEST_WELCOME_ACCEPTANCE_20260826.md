...
| `python -m pytest -q` | 227 passed，3 skipped |
| `npm run test:unit -- --run` | 49 tests passed |
| `npm run build` | TypeScript 与 Vite 生产构建通过 |
| `npx playwright test frontend-redesign.spec.ts` | 61 passed，61 条按项目/视觉开关预期 skipped，0 failed |
| `npx playwright test formula-composer.spec.ts` | 11 passed，3 skipped，0 failed |
| `npx playwright test photo-recognize.spec.ts` | 9 passed，5 skipped，0 failed |
